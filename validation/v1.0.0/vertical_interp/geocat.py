...
def pressure_from_hybrid(psfc, hya, hyb, p0=100000.):
    pressure = hya * p0 + hyb * psfc

    return pressure.transpose("time", "lev", "lat", "lon")


def geocat_interp_hybrid_to_pressure(data,
                              ps,
                              hyam,
                              hybm,
                              p0=100000.,
    ...
    pressure = pressure_from_hybrid(ps, hyam, hybm, p0)  # Pa
